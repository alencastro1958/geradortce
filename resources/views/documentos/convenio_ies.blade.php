...
<head>
    <meta charset="UTF-8">
    <title>Termo de Convênio IES</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body { margin: 0; font-family: 'Times New Roman', Times, serif; font-size: 12pt; line-height: 1.6; padding-top: 4.0cm; padding-bottom: 1.0cm; }
...
<body>
    ...
    <div class="mb-2">
        ...
        <p>O presente Convênio tem por objeto a concessão de estágio aos alunos da CONCEDENTE, visando ao aprendizado práticoernero e complementar do ensinoaprendizagem.</p>
    </div>
