...
<head>
    ...
    <title>Novo Relatório – Portal do Supervisor</title>
...
<body class="bg-gray-50 min-h-screen">
    <nav class="bg-white border-b shadow-sm px-6 py-4 flex items-center justify-between">
        <div>
            ...
            <span class="font-bold text-lg text-indigo-700 ml-4">Novo Relatório Semestral</span>
        </div>
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
        ...
        <form method="POST" action="{{ route('supervisor.relatorio.salvar', $estagio) }}" class="bg-white rounded-2xl shadow p-8 space-y-6">
            @csrf

            @php $relatorio = null; @endphp
