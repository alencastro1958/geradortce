                ...
                <div class="p-10">
                    ...
                    <div class="border-t border-gray-100 pt-8 mt-8">
                        ...
                        @else
                            ...
                            @endif
                            @if(session('warning'))
                                <div class="mb-3 p-3 bg-yellow-50 border border-yellow-300 rounded-xl text-sm text-yellow-800">{{ session('warning') }}</div>
                            @endif
                            @if(session('error'))
                                    ...
                                    <tbody class="divide-y divide-gray-100 bg-white">
                                        ...
                                        <tr class="hover:bg-gray-50 align-top">
                                            ...
                                            <td class="px-4 py-3">
                                                ...
                                                @else
                                                    <div x-data="{ open: false, show1: false, show2: false }">
                                                        ...
                                                        <div x-show="open" style="display:none;" class="mt-2 space-y-1">
                                                            <p class="text-xs text-gray-500 mb-1">
                                                                Login: <strong>{{ $sup->email ?: '(sem e-mail cadastrado)' }}</strong>
                                                            </p>
                                                            <form method="POST" action="{{ route('supervisor.criar-acesso', $sup) }}"
                                                                ...
                                                                <div class="relative w-44">
                                                                    <input :type="show1 ? 'text' : 'password'" name="password" required minlength="8"
                                                                        ...
                                                                        class="rounded-lg border-gray-300 text-xs px-2 py-1 pr-8 w-full focus:border-indigo-400 focus:ring-indigo-400">
                                                                    <button type="button" @click="show1 = !show1"
                                                                        class="absolute inset-y-0 right-1 flex items-center text-gray-400 hover:text-gray-600">
                                                                        <svg x-show="!show1" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                                                        <svg x-show="show1" style="display:none;" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>
                                                                    </button>
                                                                </div>
                                                                <div class="relative w-44">
                                                                    ...
                                                                    <button type="button" @click="show2 = !show2"
                                                                        class="absolute inset-y-0 right-1 flex items-center text-gray-400 hover:text-gray-600">
                                                                        <svg x-show="!show2" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                                                        <svg x-show="show2" style="display:none;" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>
                                                                    </button>
                                                                </div>
                                                                <button type="submit"
