                                    ...
                                    <tr class="hover:bg-blue-50/30 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <div class="flex justify-end gap-1">
                                                <!-- Visualizar TCE -->
                                                <a href="{{ route('estagios.gerar-documento', $estagio->id) }}?tipo=tce" target="_blank" class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-all" title="Visualizar TCE">
                                                ...
                                                <!-- Baixar TCE -->
                                                <a href="{{ route('estagios.baixar-documento', $estagio->id) }}?tipo=tce" class="p-2 text-green-600 hover:bg-green-50 rounded-lg transition-all" title="Baixar TCE">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
