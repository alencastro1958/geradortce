                                    ...
                                    <tr class="hover:bg-blue-50/30 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex justify-end gap-3">
                                                ...
                                                <form action="{{ route('seguradoras.destroy', $seguradora->id) }}" method="POST" class="inline" onsubmit="return confirm('Deseja realmente remover esta seguradora?')">
                                                    @csrf
                                                    @method('DELETE')
                                    ...
                                    <tr>
                                        <td colspan="3" class="px-6 py-12 text-center text-gray-500">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="text-xl font-medium text-gray-400">Nenhuma seguradora encontrada</p>
                                                <a href="{{ route('seguradoras.create') }}" class="mt-4 text-indigo-600 hover:text-indigo-800 font-semibold">Cadastre a primeira agora &rarr;</a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
